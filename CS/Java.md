[JavaSE , JavaEE 애플리케이션 차이](#java-se-와-java-ee-애플레키이션-차이)<br>
[Java 와 C, C++](#java-와-c--c-의-차이점)<br>
[Java 장단점](#java-의-장단점)<br>
[Java 컴파일 과정](#자바-컴파일과정)<br>
[접근 제어자](#접근-제어자)<br>
[데이터 타입](#데이터-타입)<br>
[Wrapper-calss](#wrapper-class)<br>
[객체지향 5원칙 SOLID](#객체지향-설계-5원칙)_<br>
[객체지향 프로그래밍 , 절차지향 프로그래밍](#객체지향-프로그래밍--절차지향-프로그래밍)<br>
[객체지향](#객제지향)<br>
[객체지향 특징 OOP](#객체지향-특징-OOP)<br>
[오버로딩과 오버라이딩](#오버로딩-과-오버라이딩)<br>
[인터페이스](#인터페이스-interface)<br>
[인터페이스와 추상클래스의 차이점](#인터페이스와-추상-클래스의-차이점)<br>
[static 키워드](#static)
[인스턴스변수 , static변수 ](#인스턴스-변수--static-변수)<br>
[final](#final-키워드)<br>
[클래스, 인스턴스]()
...
- 캡슐화
    - 객체의 데이터(속성)와 그 데이터를 다루는 로직을 하나로 묶은 것
      - 속성 , 메서드 를 하나의 캡슐처럼 하나의 묶음으로 만들어서 필요한 기능을 메서드를 통해 외부에 제공하는 것
    ...
    - 정보은닉은 객체의 내부구현을 외부에서 몰라도 사용 하게 만든것 ,  외부에는 공개된 인터페이스로만 노출 `gettet`,`setter` 로만 접근
...
- 멤버변수 
  ...
  - 클래스 변수는 인스턴스를 생성하지 않고 사용가능
  - 클래스가 메모리에 로드될때 생성된다
- 메서드
  - 인스턴스를 생성하지 않고 호출이 가능한 static 메서드
  - static 메서드 내에서는 인스턴스 멤버들을 직접 사용할수 없다
